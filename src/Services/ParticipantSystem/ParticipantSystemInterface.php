...
{   
     ...
     * @throws  \Exception                          Throws an \Exception when array of users ids is empty or proccess of adding fails
     * @return  Chat
     */
     ...
     * @throws  \Exception                                  Throws an \Exception when array of participants is empty ...
     * @return  Chat
     */
